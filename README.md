...
This table lists the configuration variables required to operate Zoom. These variables are specified when configuring a Zoom Meetings asset in Splunk SOAR.
...
action_result.data.\*.custom_attributes.\*.key | string | | examplecbf\_{0}&&&&cbf_p9y_qhefsveacfrdepuvzw |
